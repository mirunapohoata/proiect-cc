    ...
    return (
        <section className={"bg-white min-h-screen"}>
            <div className={"container px-6 py-10 mx-auto"}>
                ...
                <form>
                    <div className="mb-6">
                        <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Your title</label>
                    ...
                    <div className="mb-6">
                        <label htmlFor="description"
                            className="block mb-2 text-sm font-medium text-gray-900">Your fun fact</label>
